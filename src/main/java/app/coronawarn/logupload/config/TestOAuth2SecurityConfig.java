...
public class TestOAuth2SecurityConfig {
    ...
    /**
     * FilterChain to manage access to Resources.
     */
    @Bean
    ...
    @Bean
    public SessionRepository<org.springframework.session.MapSession> sessionRepository() {
    ...
    /**
     * AuthoritiesMapper maps OID roles to grantedAuthorities.
     */
    @Bean
